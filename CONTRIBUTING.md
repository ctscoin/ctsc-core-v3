Contributing to CTSC
==================================

The CTSC project operates an open contributor model where anyone is
...
The following applies to code changes to the CTSC project, and is not to be
confused with overall CTSC Network Protocol consensus changes.

Whether a pull request is merged into CTSC rests with the project merge
...
The project leader is the release manager for each CTSC release.
