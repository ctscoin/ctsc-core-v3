...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    overviewAction->setObjectName("overviewIcon");
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CTSC"), this);
    aboutAction->setStatusTip(tr("Show information about CTSC"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the CTSC help message to get a list with possible CTSC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CTSC Client") + " " + networkStyle->getTitleAddText();
