                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    CAmount ctscAvailableBalance = balance - immatureBalance - nLockedBalance;

    // CTSC Watch-Only Balance
    CAmount nTotalWatchBalance = watchOnlyBalance + watchUnconfBalance;
    CAmount nAvailableWatchBalance = watchOnlyBalance - watchImmatureBalance - nWatchOnlyLockedBalance;

    // CTSC labels
    ui->labelBalance->setText(BitcoinUnits::floorHtmlWithUnit(nDisplayUnit, ctscAvailableBalance, false, BitcoinUnits::separatorAlways));
    ...
    // CTSC Available
    bool showCTSCAvailable = settingShowAllBalances || ctscAvailableBalance != nTotalBalance;
    bool showWatchOnlyCTSCAvailable = showCTSCAvailable || nAvailableWatchBalance != nTotalWatchBalance;
    ui->labelBalanceText->setVisible(showCTSCAvailable || showWatchOnlyCTSCAvailable);
    ui->labelBalance->setVisible(showCTSCAvailable || showWatchOnlyCTSCAvailable);
    ui->labelWatchAvailable->setVisible(showCTSCAvailable && showWatchOnly);

    // CTSC Pending
    bool showCTSCPending = settingShowAllBalances || unconfirmedBalance != 0;
    bool showWatchOnlyCTSCPending = showCTSCPending || watchUnconfBalance != 0;
    ui->labelPendingText->setVisible(showCTSCPending || showWatchOnlyCTSCPending);
    ui->labelUnconfirmed->setVisible(showCTSCPending || showWatchOnlyCTSCPending);
    ui->labelWatchPending->setVisible(showCTSCPending && showWatchOnly);
    ...
    // CTSC Locked
    bool showCTSCLocked = settingShowAllBalances || nLockedBalance != 0;
    bool showWatchOnlyCTSCLocked = showCTSCLocked || nWatchOnlyLockedBalance != 0;
    ui->labelLockedBalanceText->setVisible(showCTSCLocked || showWatchOnlyCTSCLocked);
    ui->labelLockedBalance->setVisible(showCTSCLocked || showWatchOnlyCTSCLocked);
    ui->labelWatchLocked->setVisible(showCTSCLocked && showWatchOnly);
...
void OverviewPage::SetLinks()
{
    ...
    ui->labelLinks2->setText("Platform:");
