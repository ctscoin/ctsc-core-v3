...
{
    std::string genesisblockhash = "00000650aaea7384d7c1576f59777f391f924195ae21fd23e5348c921315226b";
...
std::string BlockToString(CBlockIndex* pBlock)
{
    ...
    if (pBlock->nHeight == 0)
        ...
        Generated = GetBlockValue(pBlock->nHeight - 1) + GetTreasuryAward(pBlock->nHeight - 1);
