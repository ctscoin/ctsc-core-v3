...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_24_TREASURY_PAYMENT_ENFORCEMENT ) r = SPORK_24_TREASURY_PAYMENT_ENFORCEMENT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_24_TREASURY_PAYMENT_ENFORCEMENT" ) return SPORK_24_TREASURY_PAYMENT_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_24_TREASURY_PAYMENT_ENFORCEMENT ) return "SPORK_24_TREASURY_PAYMENT_ENFORCEMENT";
