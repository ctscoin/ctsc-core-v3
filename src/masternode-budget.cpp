...
CAmount CBudgetManager::GetTotalBudget(int nHeight)
{
    ...
    // value based on # coin, not %
    if (nHeight <= 590000)
        nSubsidy = 0 * COIN;
    else if (nHeight > 590000 && nHeight <= 690000)
        nSubsidy = 1.05 * COIN;
    else if (nHeight > 690000 && nHeight <= 790000)
        nSubsidy = 0.90 * COIN;
    else if (nHeight > 790000 && nHeight <= 890000)
        nSubsidy = 0.60 * COIN;
    else if (nHeight > 890000 && nHeight <= 990000)
        nSubsidy = 0.45 * COIN;
    else if (nHeight > 990000 && nHeight <= 2490000)
        nSubsidy = 0.30 * COIN;
    else
        nSubsidy = 0.05 * COIN;
